...
# ---- pmpermit ----
    ...
    PMPERMIT_PIC = os.getenv("PMPERMIT_PIC", "https://telegra.ph/file/7b2a3fa167686dfaa3da8.jpg")
...
# ---- user ----
    ...
    USER_PIC = os.getenv("USER_PIC", "https://telegra.ph/file/7b2a3fa167686dfaa3da8.jpg")
