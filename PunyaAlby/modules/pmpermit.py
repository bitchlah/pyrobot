...
@Client.on_message(filters.command(["app", "ok", "approve"], ["."]) & filters.me & filters.private)
...
@Client.on_message(filters.command(["dapp", "block", "dapprove", "disapprove", "dp"], ["."]) & filters.me & filters.private)
